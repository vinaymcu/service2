...
public class GetUserDevicesResponse {
	...
	private UserDevicesResultObject resultObj;
	 ...
	 */
	@JsonProperty("resultObj")
	public UserDevicesResultObject getResultObj() {
		return resultObj;
	}
	 ...
	 */
	@JsonProperty("resultObj")
	public void setResultObj(UserDevicesResultObject resultObj) {
	...
	public boolean equals(Object other) {
		...
		if (other == this) {
			isEqual = true;
		} else if ((other instanceof GetUserDevicesResponse) == false) {
			isEqual = false;
		} else {
